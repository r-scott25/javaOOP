...
public class ConditionalArrayList extends ArrayList<Integer> {

    private Predicate<Integer> condition;


    public ConditionalArrayList(Predicate<Integer> predicate, Integer... nums) {
        super(new ConditionalArrayList(predicate, Arrays.asList(nums)));
    }

    public ConditionalArrayList(Predicate<Integer> predicate, List<Integer> arrayList) {
